...
public class ReportGenerator {
	...
	public void generateSummaryReport(String startDate, String endDate){
		...
		//WHY YOU NO USE VALUE SET USERZ?
		
		//apply rules and logic
		//ArrayList<String> users = new ArrayList<String>();
		
		Set<String> measureUsers = new HashSet<String>();
		Set<String> valueOnlyUsers = new HashSet<String>();
		...
		for(LinkedHashMap<String, Object> vsetRow : vSetRows){
			...
			if(!measureUsers.contains(userId)){
				valueOnlyUsers.add(userId);
			}
		}
		
		Set<String> users = new HashSet<String>();
		for(String s : measureUsers)
			users.add(s);
		
		for(String s : valueOnlyUsers)
			users.add(s);
		...
		excelWrkbkGenerator.createSummaryWorkSheet(CommonConstants.THIRD_WKST, reportRows, getSummaryReportHeaders());
	...
	public void generateQDMElementsReport(String startDateStr, String endDateStr){
		LinkedHashMap<String, Object> data = dataAccess.retrieveQDMElements(startDateStr, endDateStr);
		LinkedHashMap<String,LinkedHashMap<String,Object>> qdmRows = (LinkedHashMap<String,LinkedHashMap<String,Object>>)data.get("qdmList");
		...
		Iterator<Map.Entry<String, LinkedHashMap<String, Object>>> catMapItr = qdmRows.entrySet().iterator();			

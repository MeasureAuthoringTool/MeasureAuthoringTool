...
import org.ifmc.mat.report.dataaccess.DataAccess;
import org.ifmc.mat.report.row.SummaryReportRow;
...
public class ReportGenerator {
	...
	public void generateSummaryReport(String startDate, String endDate){
		...
		excelWrkbkGenerator.createSummaryWorkSheet("3-Summary of Meas. & VS by User", reportRows, getSummaryReportHeaders());

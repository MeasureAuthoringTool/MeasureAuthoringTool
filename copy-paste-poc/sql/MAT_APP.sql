...
-- -----------------------------------------------------
-- Table `MAT_APP`.`AUDIT_LOG`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `MAT_APP`.`AUDIT_LOG` ;

CREATE  TABLE IF NOT EXISTS `MAT_APP`.`AUDIT_LOG` (
...
-- -----------------------------------------------------
-- Table `MAT_APP`.`SECURITY_ROLE`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `MAT_APP`.`SECURITY_ROLE` ;

CREATE  TABLE IF NOT EXISTS `MAT_APP`.`SECURITY_ROLE` (
...
-- -----------------------------------------------------
-- Table `MAT_APP`.`STATUS`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `MAT_APP`.`STATUS` ;

CREATE  TABLE IF NOT EXISTS `MAT_APP`.`STATUS` (
...
-- Table `MAT_APP`.`USER`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `MAT_APP`.`USER` ;

CREATE  TABLE IF NOT EXISTS `MAT_APP`.`USER` (
  ...
  CONSTRAINT `USER_SECURITY_ROLE_FK`
    ...
    REFERENCES `MAT_APP`.`SECURITY_ROLE` (`SECURITY_ROLE_ID` )
    ON DELETE CASCADE
    ON UPDATE CASCADE,
  CONSTRAINT `USER_AUDIT_FK`
    FOREIGN KEY (`AUDIT_ID` )
    REFERENCES `MAT_APP`.`AUDIT_LOG` (`AUDIT_LOG_ID` )
    ON DELETE CASCADE
    ON UPDATE CASCADE,
  CONSTRAINT `USER_STATUS_FK`
    FOREIGN KEY (`STATUS_ID` )
    REFERENCES `MAT_APP`.`STATUS` (`STATUS_ID` )
    ON DELETE CASCADE
    ON UPDATE CASCADE)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `MAT_APP`.`USER_PASSWORD`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `MAT_APP`.`USER_PASSWORD` ;

CREATE  TABLE IF NOT EXISTS `MAT_APP`.`USER_PASSWORD` (
  ...
  CONSTRAINT `PASSWORD_USER_FK`
    FOREIGN KEY (`USER_ID` )
    REFERENCES `MAT_APP`.`USER` (`USER_ID` )
    ON DELETE CASCADE
    ON UPDATE CASCADE)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `MAT_APP`.`USER_SECURITY_QUESTIONS`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `MAT_APP`.`USER_SECURITY_QUESTIONS` ;

CREATE  TABLE IF NOT EXISTS `MAT_APP`.`USER_SECURITY_QUESTIONS` (
  `USER_ID` VARCHAR(40) NOT NULL ,
...
-- -----------------------------------------------------
-- Table `MAT_APP`.`OBJECT_STATUS`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `MAT_APP`.`OBJECT_STATUS` ;

CREATE  TABLE IF NOT EXISTS `MAT_APP`.`OBJECT_STATUS` (
...
-- -----------------------------------------------------
-- Table `MAT_APP`.`CATEGORY`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `MAT_APP`.`CATEGORY` ;

CREATE  TABLE IF NOT EXISTS `MAT_APP`.`CATEGORY` (
...
-- -----------------------------------------------------
-- Table `MAT_APP`.`MEASURE_TYPES`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `MAT_APP`.`MEASURE_TYPES` ;

CREATE  TABLE IF NOT EXISTS `MAT_APP`.`MEASURE_TYPES` (
...
-- -----------------------------------------------------
-- Table `MAT_APP`.`STEWARD_ORG`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `MAT_APP`.`STEWARD_ORG` ;

CREATE  TABLE IF NOT EXISTS `MAT_APP`.`STEWARD_ORG` (
  `ID` VARCHAR(32) NOT NULL ,
...
-- -----------------------------------------------------
-- Table `MAT_APP`.`AUTHOR`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `MAT_APP`.`AUTHOR` ;

CREATE  TABLE IF NOT EXISTS `MAT_APP`.`AUTHOR` (
  `ID` VARCHAR(32) NOT NULL ,
...
-- -----------------------------------------------------
-- Table `MAT_APP`.`DATA_TYPE`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `MAT_APP`.`DATA_TYPE` ;

CREATE  TABLE IF NOT EXISTS `MAT_APP`.`DATA_TYPE` (
  ...
  CONSTRAINT `DATA_TYPE_CAT_FK`
    ...
    REFERENCES `MAT_APP`.`CATEGORY` (`CATEGORY_ID` )
    ON DELETE CASCADE
    ON UPDATE CASCADE)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `MAT_APP`.`CODE_SYSTEM`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `MAT_APP`.`CODE_SYSTEM` ;

CREATE  TABLE IF NOT EXISTS `MAT_APP`.`CODE_SYSTEM` (
...
-- -----------------------------------------------------
-- Table `MAT_APP`.`LIST_OBJECT`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `MAT_APP`.`LIST_OBJECT` ;

CREATE  TABLE IF NOT EXISTS `MAT_APP`.`LIST_OBJECT` (
  ...
  CONSTRAINT `LIST_OBJECT_CODE_SYSTEM_FK`
    ...
    REFERENCES `MAT_APP`.`CODE_SYSTEM` (`CODE_SYSTEM_ID` )
    ON DELETE CASCADE
    ON UPDATE CASCADE,
  CONSTRAINT `LIST_OBJECT_STEWARD_FK`
    FOREIGN KEY (`STEWARD` )
    REFERENCES `MAT_APP`.`STEWARD_ORG` (`ID`)
    ON DELETE CASCADE
    ON UPDATE CASCADE,
  CONSTRAINT `LIST_OBJECT_STATUS_FK`
    FOREIGN KEY (`OBJECT_STATUS_ID` )
    REFERENCES `MAT_APP`.`OBJECT_STATUS` (`OBJECT_STATUS_ID` )
    ON DELETE CASCADE
    ON UPDATE CASCADE,
...
-- -----------------------------------------------------
-- Table `MAT_APP`.`LIST_OBJECT_OID_GEN`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `MAT_APP`.`LIST_OBJECT_OID_GEN` ;

CREATE  TABLE IF NOT EXISTS `MAT_APP`.`LIST_OBJECT_OID_GEN` (
  `LIST_OBJECT_OID_GEN_ID` BIGINT NOT NULL AUTO_INCREMENT,
  PRIMARY KEY(`LIST_OBJECT_OID_GEN_ID`)
)
ENGINE = InnoDB;
-- -----------------------------------------------------
-- Table `MAT_APP`.`CODE_LIST`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `MAT_APP`.`CODE_LIST` ;

CREATE  TABLE IF NOT EXISTS `MAT_APP`.`CODE_LIST` (
...
-- Table `MAT_APP`.`CODE`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `MAT_APP`.`CODE` ;

CREATE  TABLE IF NOT EXISTS `MAT_APP`.`CODE` (
  ...
  CONSTRAINT `CODE_LIST_FK`
    FOREIGN KEY (`CODE_LIST_ID` )
    REFERENCES `MAT_APP`.`CODE_LIST` (`CODE_LIST_ID` )
    ON DELETE CASCADE
    ON UPDATE CASCADE)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `MAT_APP`.`GROUPED_CODE_LISTS`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `MAT_APP`.`GROUPED_CODE_LISTS` ;
CREATE  TABLE IF NOT EXISTS `MAT_APP`.`GROUPED_CODE_LISTS` (
...
-- -----------------------------------------------------
-- Table `MAT_APP`.`CONTEXT`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `MAT_APP`.`CONTEXT` ;

CREATE  TABLE IF NOT EXISTS `MAT_APP`.`CONTEXT` (
...
-- -----------------------------------------------------
-- Table `MAT_APP`.`OPERATOR`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `MAT_APP`.`OPERATOR` ;

CREATE  TABLE IF NOT EXISTS `MAT_APP`.`OPERATOR` (
...
-- -----------------------------------------------------
-- Table `MAT_APP`.`STATIC_ELEMENT`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `MAT_APP`.`STATIC_ELEMENT` ;

CREATE  TABLE IF NOT EXISTS `MAT_APP`.`STATIC_ELEMENT` (
...
-- Table `MAT_APP`.`TERM`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `MAT_APP`.`TERM` ;

CREATE  TABLE IF NOT EXISTS `MAT_APP`.`TERM` (
  ...
  CONSTRAINT `OPERATOR_ID_FK`
    ...
    REFERENCES `MAT_APP`.`OPERATOR` (`OPERATOR_ID` )
    ON DELETE CASCADE
    ON UPDATE CASCADE,
  CONSTRAINT `NEXT_TERM_ID_FK`
    FOREIGN KEY (`NEXT_TERM_ID` )
    REFERENCES `MAT_APP`.`TERM` (`TERM_ID` )
    ON DELETE CASCADE
    ON UPDATE CASCADE,
  CONSTRAINT `STATIC_ELEMENT_ID_FK`
    FOREIGN KEY (`STATIC_ELEMENT_ID` )
    REFERENCES `MAT_APP`.`STATIC_ELEMENT` (`STATIC_ELEMENT_ID` )
    ON DELETE CASCADE
    ON UPDATE CASCADE,
  CONSTRAINT `QDS_ELEMENT_ID_FK`
    FOREIGN KEY (`QDS_ELEMENT_ID` )
    REFERENCES `MAT_APP`.`QDS_ELEMENT` (`QDS_ELEMENT_ID` )
    ON DELETE CASCADE
    ON UPDATE CASCADE
)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `MAT_APP`.`QDS_ELEMENT`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `MAT_APP`.`QDS_ELEMENT` ;

CREATE  TABLE IF NOT EXISTS `MAT_APP`.`QDS_ELEMENT` (
  `QDS_ELEMENT_ID` VARCHAR(64) NOT NULL ,
  ...
  CONSTRAINT `MEASURE_PACKAGE_ID_QDS_ELEMENT_FK`
    ...
    REFERENCES `MAT_APP`.`MEASURE_PACKAGE` (`MEASURE_PACKAGE_ID` )
    ON DELETE CASCADE
    ON UPDATE CASCADE)
ENGINE = InnoDB;

-- -----------------------------------------------------
-- Table `MAT_APP`.`QDS_PROPERTY`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `MAT_APP`.`QDS_PROPERTY` ;

CREATE  TABLE IF NOT EXISTS `MAT_APP`.`QDS_PROPERTY` (
...
CREATE  TABLE IF NOT EXISTS `MAT_APP`.`ATTRIBUTE_DETAILS` (

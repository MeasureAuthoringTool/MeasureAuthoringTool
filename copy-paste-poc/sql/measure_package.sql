...
-- -----------------------------------------------------
-- Table `MAT_APP`.`DECISION`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `MAT_APP`.`DECISION` ;

CREATE  TABLE IF NOT EXISTS `MAT_APP`.`DECISION` (
...
-- -----------------------------------------------------
-- Table `MAT_APP`.`QDSTERM`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `MAT_APP`.`QDS_TERM` ;

CREATE  TABLE IF NOT EXISTS `MAT_APP`.`QDS_TERM` (
  `ID` VARCHAR(64) NOT NULL ,
...
/*
  INDEX `QDS_ELEMENT_ID_FK1` (`QDS_ELEMENT_ID` ASC),
    ...
    REFERENCES `MAT_APP`.`QDS_ELEMENT` (`ID`),
    ON DELETE CASCADE
    ON UPDATE CASCADE,
    
    CONSTRAINT `DECISION_ID_FK1`
    FOREIGN KEY (`DECISION_ID` )
    REFERENCES `MAT_APP`.`DECISION` (`ID`)
    ON DELETE CASCADE
    ON UPDATE CASCADE)
*/    
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `MAT_APP`.`MEASUREMENT_TERM`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `MAT_APP`.`MEASUREMENT_TERM` ;

CREATE  TABLE IF NOT EXISTS `MAT_APP`.`MEASUREMENT_TERM` (
  `ID` VARCHAR(64) NOT NULL ,
  `UNIT` VARCHAR(45),
...
-- -----------------------------------------------------
-- Table `MAT_APP`.`OPERATORS`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `MAT_APP`.`OPERATORS` ;

/* NOT USING, SINCE ENUMS HOLD OPERATOR INFO
CREATE  TABLE IF NOT EXISTS `MAT_APP`.`OPERATORS` (
...
*/
-- -----------------------------------------------------
-- Table `MAT_APP`.`CLAUSE`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `MAT_APP`.`CLAUSE` ;

CREATE  TABLE IF NOT EXISTS `MAT_APP`.`CLAUSE` (
  `ID` VARCHAR(32) NOT NULL ,
  `NAME` VARCHAR(100),
...
-- -----------------------------------------------------
-- Table `MAT_APP`.`MEASURE`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `MAT_APP`.`MEASURE` ;

CREATE  TABLE IF NOT EXISTS `MAT_APP`.`MEASURE` (
  `ID` VARCHAR(64) NOT NULL ,
...
-- -----------------------------------------------------
-- Table `MAT_APP`.`METADATA`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `MAT_APP`.`METADATA` ;

CREATE  TABLE IF NOT EXISTS `MAT_APP`.`METADATA` (
...
-- -----------------------------------------------------
-- Table `MAT_APP`.`QUALITY_DATA_SET`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `MAT_APP`.`QUALITY_DATA_SET` ;

CREATE  TABLE IF NOT EXISTS `MAT_APP`.`QUALITY_DATA_SET` (
...
-- -----------------------------------------------------
-- Table `MAT_APP`.`QUALITY_DATA_SET_OID_GEN`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `MAT_APP`.`QUALITY_DATA_SET_OID_GEN` ;

CREATE  TABLE IF NOT EXISTS `MAT_APP`.`QUALITY_DATA_SET_OID_GEN` (
...
-- -----------------------------------------------------
-- Table `MAT_APP`.`SHARE_LEVEL`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `MAT_APP`.`SHARE_LEVEL` ;

CREATE  TABLE IF NOT EXISTS `MAT_APP`.`SHARE_LEVEL` (
...
-- -----------------------------------------------------
-- Table `MAT_APP`.`MEASURE_SHARE`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `MAT_APP`.`MEASURE_SHARE` ;

CREATE  TABLE IF NOT EXISTS `MAT_APP`.`MEASURE_SHARE` (
  ...
  CONSTRAINT `MEASURE_SHARE_LEVEL_ID`
    ...
    REFERENCES `MAT_APP`.`SHARE_LEVEL` (`SHARE_LEVEL_ID` )
    ON DELETE CASCADE
    ON UPDATE CASCADE   
)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `MAT_APP`.`PACKAGER`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `MAT_APP`.`PACKAGER` ;

CREATE  TABLE IF NOT EXISTS `MAT_APP`.`PACKAGER` (
...
-- -----------------------------------------------------
-- Table `MAT_APP`.`QDS_ATTRIBUTES`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `MAT_APP`.`QDS_ATTRIBUTES` ;

CREATE  TABLE IF NOT EXISTS `MAT_APP`.`QDS_ATTRIBUTES` (
  `ID` VARCHAR(64) NOT NULL,
  `NAME` VARCHAR(100),
...
-- -----------------------------------------------------
-- Table `MAT_APP`.`QDS_ATTRIBUTE_DETAILS`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `MAT_APP`.`QDS_ATTRIBUTE_DETAILS` ;

CREATE  TABLE IF NOT EXISTS `MAT_APP`.`QDS_ATTRIBUTE_DETAILS` (
  `ID` VARCHAR(64) NOT NULL,
  `DECISION_ID` VARCHAR(64),
...
-- -----------------------------------------------------
-- Table `MAT_APP`.`MEASURE_EXPORT`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `MAT_APP`.`MEASURE_EXPORT` ;

CREATE  TABLE IF NOT EXISTS `MAT_APP`.`MEASURE_EXPORT` (

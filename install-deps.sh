...
#mvn install:install-file -Dfile=lib/mat-rest-commons-0.0.1-SNAPSHOT.jar -DgroupId=gov.cms.mat -DartifactId=mat-rest-commons -Dversion=0.0.1-SNAPSHOT -Dpackaging=jar

...
export const definitionExpressionBuilderBtn = '#expressionbuilderButton_definition'
export const definitionCQLExpressionEditorInput = '#definition_CQLEditor'
...
export const selectQDMDatatypeObject = '#listSelectItem'
...
export const groupingErrorOne = '.alert-danger > :nth-child(1) > b'
export const groupingErrorTwo = '.alert-danger > :nth-child(2) > b'
export const packagingErrorDiv = '.alert-danger > .gwt-HTML > b'
export const measureGroupingSuccessMessage = '.panel-body > .alert-success > .gwt-HTML > b'

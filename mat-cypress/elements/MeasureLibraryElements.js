//Tab menu navigation
export const measureLibraryTab = '#Measure\\ Library'
export const measureComposerTab = '#Measure\\ Composer'
export const cqlLibraryTab = '#CQL\\ Library'
...
export const row1RecentActivityCheckbox = '#MostRecentActivityCellTable [__gwt_row="0"] input'
export const row2RecentActivity = '#MostRecentActivityCellTable [__gwt_row="1"]'
...
export const majorVersionTypeRadio = '#majorRadio_RadioButton'
export const minorVersionTypeRadio = '#minorRadio_RadioButton'
export const packageAndVersion = '#SaveAndContinueButton_measuVersion'

...
-- -----------------------------------------------------
-- Table `MAT_APP_STAGING`.`DECISION`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `MAT_APP_STAGING`.`DECISION` ;

CREATE  TABLE IF NOT EXISTS `MAT_APP_STAGING`.`DECISION` (
...
-- -----------------------------------------------------
-- Table `MAT_APP_STAGING`.`QDSTERM`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `MAT_APP_STAGING`.`QDS_TERM` ;

CREATE  TABLE IF NOT EXISTS `MAT_APP_STAGING`.`QDS_TERM` (
  `ID` VARCHAR(64) NOT NULL ,
...
/*
  INDEX `QDS_ELEMENT_ID_FK1` (`QDS_ELEMENT_ID` ASC),
    ...
    REFERENCES `MAT_APP_STAGING`.`QDS_ELEMENT` (`ID`),
    ON DELETE CASCADE
    ON UPDATE CASCADE,
    
    CONSTRAINT `DECISION_ID_FK1`
    FOREIGN KEY (`DECISION_ID` )
    REFERENCES `MAT_APP_STAGING`.`DECISION` (`ID`)
    ON DELETE CASCADE
    ON UPDATE CASCADE)
*/    
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `MAT_APP_STAGING`.`MEASUREMENT_TERM`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `MAT_APP_STAGING`.`MEASUREMENT_TERM` ;

CREATE  TABLE IF NOT EXISTS `MAT_APP_STAGING`.`MEASUREMENT_TERM` (
  `ID` VARCHAR(64) NOT NULL ,
  `UNIT` VARCHAR(45),
...
-- -----------------------------------------------------
-- Table `MAT_APP_STAGING`.`OPERATORS`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `MAT_APP_STAGING`.`OPERATORS` ;

/* NOT USING, SINCE ENUMS HOLD OPERATOR INFO
CREATE  TABLE IF NOT EXISTS `MAT_APP_STAGING`.`OPERATORS` (
...
*/
-- -----------------------------------------------------
-- Table `MAT_APP_STAGING`.`CLAUSE`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `MAT_APP_STAGING`.`CLAUSE` ;

CREATE  TABLE IF NOT EXISTS `MAT_APP_STAGING`.`CLAUSE` (
  `ID` VARCHAR(32) NOT NULL ,
  `NAME` VARCHAR(100),
...
-- -----------------------------------------------------
-- Table `MAT_APP_STAGING`.`MEASURE`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `MAT_APP_STAGING`.`MEASURE` ;

CREATE  TABLE IF NOT EXISTS `MAT_APP_STAGING`.`MEASURE` (
  `ID` VARCHAR(64) NOT NULL ,
...
-- -----------------------------------------------------
-- Table `MAT_APP_STAGING`.`METADATA`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `MAT_APP_STAGING`.`METADATA` ;

CREATE  TABLE IF NOT EXISTS `MAT_APP_STAGING`.`METADATA` (
...
-- -----------------------------------------------------
-- Table `MAT_APP_STAGING`.`QUALITY_DATA_SET`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `MAT_APP_STAGING`.`QUALITY_DATA_SET` ;

CREATE  TABLE IF NOT EXISTS `MAT_APP_STAGING`.`QUALITY_DATA_SET` (
  ...
  CONSTRAINT `QDS_DATA_TYPE_FK`
    ...
    REFERENCES `MAT_APP_STAGING`.`DATA_TYPE` (`DATA_TYPE_ID` )
    ON DELETE CASCADE
    ON UPDATE CASCADE,
...
-- -----------------------------------------------------
-- Table `MAT_APP_STAGING`.`QUALITY_DATA_SET_OID_GEN`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `MAT_APP_STAGING`.`QUALITY_DATA_SET_OID_GEN` ;

CREATE  TABLE IF NOT EXISTS `MAT_APP_STAGING`.`QUALITY_DATA_SET_OID_GEN` (
...
-- -----------------------------------------------------
-- Table `MAT_APP_STAGING`.`SHARE_LEVEL`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `MAT_APP_STAGING`.`SHARE_LEVEL` ;

CREATE  TABLE IF NOT EXISTS `MAT_APP_STAGING`.`SHARE_LEVEL` (
...
-- -----------------------------------------------------
-- Table `MAT_APP_STAGING`.`MEASURE_SHARE`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `MAT_APP_STAGING`.`MEASURE_SHARE` ;

CREATE  TABLE IF NOT EXISTS `MAT_APP_STAGING`.`MEASURE_SHARE` (
  ...
  CONSTRAINT `MEASURE_SHARE_LEVEL_ID`
    ...
    REFERENCES `MAT_APP_STAGING`.`SHARE_LEVEL` (`SHARE_LEVEL_ID` )
    ON DELETE CASCADE
    ON UPDATE CASCADE   
)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `MAT_APP_STAGING`.`PACKAGER`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `MAT_APP_STAGING`.`PACKAGER` ;

CREATE  TABLE IF NOT EXISTS `MAT_APP_STAGING`.`PACKAGER` (
  ...
  CONSTRAINT `PACKAGER_CLAUSE_FK`
    ...
    REFERENCES `MAT_APP_STAGING`.`CLAUSE` (`ID` )
    ON DELETE CASCADE
    ON UPDATE CASCADE
)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `MAT_APP_STAGING`.`QDS_ATTRIBUTES`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `MAT_APP_STAGING`.`QDS_ATTRIBUTES` ;

CREATE  TABLE IF NOT EXISTS `MAT_APP_STAGING`.`QDS_ATTRIBUTES` (
  `ID` VARCHAR(64) NOT NULL,
  `NAME` VARCHAR(100),
...
-- -----------------------------------------------------
-- Table `MAT_APP_STAGING`.`QDS_ATTRIBUTE_DETAILS`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `MAT_APP_STAGING`.`QDS_ATTRIBUTE_DETAILS` ;

CREATE  TABLE IF NOT EXISTS `MAT_APP_STAGING`.`QDS_ATTRIBUTE_DETAILS` (
  `ID` VARCHAR(64) NOT NULL,
  `DECISION_ID` VARCHAR(64),
...
-- -----------------------------------------------------
-- Table `MAT_APP_STAGING`.`MEASURE_EXPORT`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `MAT_APP_STAGING`.`MEASURE_EXPORT` ;

CREATE  TABLE IF NOT EXISTS `MAT_APP_STAGING`.`MEASURE_EXPORT` (

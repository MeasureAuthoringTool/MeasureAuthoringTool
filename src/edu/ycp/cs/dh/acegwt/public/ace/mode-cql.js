...
var SqlHighlightRules = function() {
	...
	var keywords = (
	        ...
	        "else|end|ends|except|exists|false|flatten|from|function|hour|hours|if|implies|in|include|included|included in|includes|Integer|intersect|Interval|is|Is|less|let|library|List|" +

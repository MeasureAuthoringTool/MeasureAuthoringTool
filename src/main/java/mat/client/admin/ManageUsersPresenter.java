...
public class ManageUsersPresenter implements MatPresenter {
    ...
    private List<String> getAlertMessages(SaveUpdateUserResult result) {
        ...
        switch (result.getFailureReason()) {
            case SaveUpdateUserResult.USER_EMAIL_NOT_UNIQUE:
    ...
    public interface DetailDisplay {
         ...
         *
         * @param b the new user is active editable
         */
         ...
         *
         * @param b the new show revoked status
         */
         ...
         *
         * @param b the new show unlock option
         */
    ...
    public interface HistoryDisplay {
         ...
         *
         * @param name the new measure name
         */

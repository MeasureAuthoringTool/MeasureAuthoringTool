...
public abstract class AbstractCQLWorkspacePresenter {
    private static final Logger log = Logger.getLogger(AbstractCQLWorkspacePresenter.class.getSimpleName());
    ...
    protected void alert508StateChanges() {
        log.log(Level.INFO, "Entering alert508StateChanges");
        ...
        log.log(Level.INFO, "Leaving alert508StateChanges");
    }

    protected void clearOID() {
        log.log(Level.INFO, "Entering clearOID");
        ...
        alert508StateChanges();
        log.log(Level.INFO, "Leaving clearOID");
    }
    ...
    protected void leftNavAppliedQDMClicked() {
        appliedQDMEvent();
        cqlWorkspaceView.getValueSetView().getOIDInput().setFocus(true);
        log.log(Level.INFO, "left leftNavAppliedQDMClicked");
    }
    ...
    protected void appliedQDMEvent() {
        ...
        focusSkipLists();
        log.log(Level.INFO, "leaving appliedQDMEvent");
    }

...
public class LightBoxLeftPanelView implements LightBoxLeftPanelDisplay {
    ...
    public LightBoxLeftPanelView(String id, InsertFhirAttributesDialogModel model, String width, String height) {
        ...
        for (FhirDataTypeModel dataTypeModel : model.getDataTypesByResource().values()) {
            DataTypeSelectSelectSectionView dataTypeSection = new DataTypeSelectSelectSectionView(selectionPanelGroup.getId(), dataTypeModel, eventBus);
    ...
    public static class DataTypeSelectSelectSectionView implements DataTypeSelectSectionDisplay {
        ...
        public DataTypeSelectSelectSectionView(String parentViewId, FhirDataTypeModel dataType, HandlerManager eventBus) {
        ...
        private PanelHeader createDataTypeSectionHeader(FhirDataTypeModel dataType) {
        ...
        private void addAttributes(FhirDataTypeModel dataType) {
            for (FhirAttributeModel attribute : dataType.getAttributesByElement().values()) {
                ...
                checkBox.addValueChangeHandler(event -> {
                    FhirAttributeSelectionEvent fhirAttributeSelectionEvent = new FhirAttributeSelectionEvent(attribute.getId(), event.getValue());

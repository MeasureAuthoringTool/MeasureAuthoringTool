...
public class CQLLibraryServiceImpl extends SpringRemoteServiceServlet implements CQLLibraryService {
    ...
    @Autowired
    private CQLLibraryServiceInterface cqlLibraryService;
    ...
    public SaveCQLLibraryResult saveFinalizedVersion(String libraryId,
                                                     ...
                                                     boolean keepALL) {
        return this.getCQLLibraryService()
                .saveFinalizedVersion(libraryId, isMajor, version, ignoreUnusedLibraries, keepALL);
    }
    ...
    public XmlProcessor loadCQLXmlTemplateFile(boolean isFhir) {
        return this.getCQLLibraryService().loadCQLXmlTemplateFile(isFhir);
    }
    ...
    @Override
    public SaveUpdateCQLResult saveAndModifyFunctions(String libraryId, CQLFunctions toBeModifiedObj, CQLFunctions currentObj,
    ...
    @Override
    public void transferLibraryOwnerShipToUser(List<String> list, String toEmail) {

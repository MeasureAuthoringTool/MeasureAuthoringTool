...
public class ZipPackager {
    ...
    @Autowired
    private ExportUtility exportUtils;
    ...
    public void getZipBarr(String emeasureName, ZipOutputStream zip, String emeasureHTMLStr, String simpleXmlStr,
        ...
        try {
            ...
            if (!measure.isFhirMeasure()) {
                String emeasureHumanReadablePath = parentPath + File.separator + FileNameUtility.getEmeasureHumanReadableName(emeasureName + "_" + currentRealeaseVersion);
                addBytesToZip(emeasureHumanReadablePath, emeasureHTMLStr.getBytes(), zip);

                String emeasureXMLPath = parentPath + File.separator + FileNameUtility.getEmeasureXMLName(emeasureName + "_" + currentRealeaseVersion);
                addBytesToZip(emeasureXMLPath, emeasureXMLStr.getBytes(), zip);
                ...
                String measureXMLPath = parentPath + File.separator + MEASURE + FileNameUtility.getXmlFilePath(emeasureName, currentRealeaseVersion);
                addBytesToZip(measureXMLPath, exportUtils.getFhirXml(measureExport).getBytes(), zip);
                ...
                addBytesToZip(measureLibraryXmlPath,exportUtils.getIncludedLibsXml(measureExport).getBytes(), zip);
                ...
                addBytesToZip(cqlLibraryXmlPath, exportUtils.getFhirXml(cqlLibraryExport).getBytes(), zip);

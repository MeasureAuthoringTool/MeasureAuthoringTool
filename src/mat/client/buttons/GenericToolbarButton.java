 ...
 * on the Copy/Paste/SelectAll/Clear toolbar
 */
public abstract class GenericToolbarButton extends Button{
	 ...
	 * @param sectionName 	where the button toolbar is located (what page)
	 */
	public GenericToolbarButton(String name, String sectionName) {
		button.setType(ButtonType.LINK);
		button.getElement().setId(name.toLowerCase()+"Button_"+sectionName);

...
public class PasswordRules extends Composite {
	...
	public PasswordRules() {
		...
		HTML desc = new HTML("Passwords must not consist of a single dictionary word with letters, numbers and symbols. <br><br> Passwords must be between 8 and 16 characters and contain each one the following:");

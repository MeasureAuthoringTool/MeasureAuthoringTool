...
public class PasswordRules extends Composite {
	...
	public PasswordRules() {
		...
		HTML desc = new HTML("Passwords should not consist of a single dictionary word with random numbers and symbols. <br> Passwords  should be between 8 and 16<br>characters and contain at least one of the following:");

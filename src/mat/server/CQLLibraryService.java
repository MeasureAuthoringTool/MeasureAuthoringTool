...
public class CQLLibraryService implements CQLLibraryServiceInterface {
	...
	public List<CQLLibraryDataSetObject> search(String searchText, String searchFrom) {
		// List<CQLLibraryModel> cqlLibraries = new
	...
	@Override
	public void save(String libraryName, String measureId, User owner, MeasureSet measureSet, String version,
			String releaseVersion, Timestamp finalizedDate, byte[] cqlByteArray) {
	...
	private CQLLibraryDataSetObject extractCQLLibraryDataObject(CQLLibrary cqlLibrary) {
		...
		try {
			...
			// cqlService.parseCQLStringForError(cqlFileString);

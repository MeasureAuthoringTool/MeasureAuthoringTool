...
import org.ifmc.mat.client.clause.presenter.DiagramPresenter;
import org.ifmc.mat.client.clause.view.DiagramViewImpl;
import org.ifmc.mat.client.clause.view.shape.TextRectangle;
import org.ifmc.mat.client.codelist.service.CodeListService;
import org.ifmc.mat.client.codelist.service.CodeListServiceAsync;
import org.ifmc.mat.client.diagramObject.Conditional;
import org.ifmc.mat.client.diagramObject.Criterion;
import org.ifmc.mat.client.diagramObject.CriterionParent;
import org.ifmc.mat.client.diagramObject.DiagramObject;
import org.ifmc.mat.client.diagramObject.PlaceHolder;
import org.ifmc.mat.client.diagramObject.Qdsel;
import org.ifmc.mat.client.diagramObject.Rel;
import org.ifmc.mat.client.diagramObject.SimpleStatement;
import org.ifmc.mat.client.diagramObject.SimpleStatementBuilder;
import org.ifmc.mat.client.diagramObject.SimpleStatementToCentralPojoFactory;
import org.ifmc.mat.client.diagramObject.clickHandler.PlaceholderClickHandler;
...
import org.ifmc.mat.shared.TopologicalSort;
...
//				refreshLibaryAndPhrases();
	...
	private void populateChild(Decision decision, String currentCriterion, DiagramObject currentDiagramObject) {
		...
		//CONDITIONAL
		if(decision instanceof org.ifmc.mat.shared.model.Conditional) {
			org.ifmc.mat.shared.model.Conditional c = (org.ifmc.mat.shared.model.Conditional) decision;
	...
	private org.ifmc.mat.shared.model.Decision createDecision(
			TraversalTree rule, SimpleStatementToCentralPojoFactory sstcpf) throws Exception {

		org.ifmc.mat.shared.model.Decision childDec = null;

		if(rule.getDiagramObject() instanceof Conditional) {
			Conditional uiCond = (Conditional)rule.getDiagramObject();
			org.ifmc.mat.shared.model.Conditional cond = new org.ifmc.mat.shared.model.Conditional();
			childDec = cond;
			...
			org.ifmc.mat.shared.model.QDSMeasurementTerm qdsMeasure = new QDSMeasurementTerm();
			childDec = qdsMeasure;
	...
	private void addChildDecision(org.ifmc.mat.shared.model.Decision dec,
			org.ifmc.mat.shared.model.Decision child) {
		...
		} else if (dec instanceof org.ifmc.mat.shared.model.Conditional) {

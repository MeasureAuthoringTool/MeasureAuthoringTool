...
public class SimpleStatementToCentralPojoFactory {
	...
	private Clause getLogical() throws Exception {
		org.ifmc.mat.shared.model.Conditional conditional = measurePhrase.condition
				.equalsIgnoreCase("AND") ? new org.ifmc.mat.shared.model.And()
				: new org.ifmc.mat.shared.model.Or();
	...
	private Decision getFunctionTerm(org.ifmc.mat.shared.model.Decision decision)
			throws Exception {

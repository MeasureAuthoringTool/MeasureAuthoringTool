...
public org.ifmc.mat.dao.QualityDataSetDAO getQdsDAO() {
	return (org.ifmc.mat.dao.QualityDataSetDAO)context.getBean("qualityDataSetDAO");
}

public org.ifmc.mat.dao.clause.QDSAttributeDetailsDAO getqDSAttributeDetailsDAO() {
	if (dAOService!=null) return dAOService.getqDSAttributeDetailsDAO();
	if (context!=null) return (org.ifmc.mat.dao.clause.QDSAttributeDetailsDAO)context.getBean("qDSAttributeDetailsDAO");
	return qDSAttributeDetailsDAO;
}

public org.ifmc.mat.dao.clause.QDSAttributesDAO getqDSAttributesDAO() {
	if (dAOService!=null) return dAOService.getqDSAttributesDAO();
	if (context!=null) return (org.ifmc.mat.dao.clause.QDSAttributesDAO)context.getBean("qDSAttributesDAO");
...
public org.ifmc.mat.dao.clause.QDSTermDAO getqDSTermDAO() {
	...
	if (context!=null) return (org.ifmc.mat.dao.clause.QDSTermDAO)context.getBean("qDSTermDAO");
	return qDSTermDAO;
}
...
public org.ifmc.mat.dao.clause.MeasurementTermDAO getMeasurementTermDAO() {
	...
	if (context!=null) return (org.ifmc.mat.dao.clause.MeasurementTermDAO)context.getBean("measurementTermDAO");
...
public org.ifmc.mat.dao.clause.DecisionDAO getDecisionDAO() {
	...
	if (context!=null) return (org.ifmc.mat.dao.clause.DecisionDAO)context.getBean("decisionDAO");
	return decisionDAO;
}
public org.ifmc.mat.dao.clause.ClauseDAO getClauseDAO() {
	if (dAOService!=null) return dAOService.getClauseDAO();
	if (context!=null) return (org.ifmc.mat.dao.clause.ClauseDAO)context.getBean("clauseDAO");
	return clauseDAO;
}

public org.ifmc.mat.dao.clause.MeasureDAO getMeasureDAO() {
	if (dAOService!=null) return dAOService.getMeasureDAO();
	if (context!=null) return (org.ifmc.mat.dao.clause.MeasureDAO)context.getBean("measureDAO");
	return measureDAO;
}
...
//****************************LOAD*********************************
	public org.ifmc.mat.shared.model.Decision loadClause(String parentId)  {
	...
	public org.ifmc.mat.shared.model.Decision loadClause(String parentId, ApplicationContext ctx)  {
		this.context = ctx;
	...
	private void loadAllChild(org.ifmc.mat.shared.model.Decision currentTopLevelCentralPojo, Decision topLevelDBDecision) {
	...
	private void setChildToParent(org.ifmc.mat.shared.model.Decision currentTopLevelCentralPojo, 
	...
	//save - process child
	private void saveChildDecision(org.ifmc.mat.shared.model.Decision decisionPojo, Decision dbTopLevelParent, List<Object> terms, int orderNum, String dataTypeName) {
		...
		if (decisionPojo instanceof QDSMeasurementTerm) {
			...
			//PROCESS ATTRIBUTES
			List<org.ifmc.mat.shared.model.Decision> attrs = qDSTerm.getAttributes();
			if(attrs!=null && !attrs.isEmpty()) {
				int ord = -1;
				for (org.ifmc.mat.shared.model.Decision d : attrs) {
					ord++;
			...
			if (foundClause!=null) {
				if (measureLtForCloning!=null) {
					...
					if (foundClonedClause!=null) {
						...
						for (org.ifmc.mat.shared.model.Decision d : temp.getDecisions()) {
	...
	public void cloneClause(Clause clausePojo, Measure clonedMeasure, 
		...
		org.ifmc.mat.shared.model.Decision dec = null;
		...
		for (org.ifmc.mat.shared.model.Decision decisionPojo : dec.getDecisions()) {
			saveChildDecision(decisionPojo, dbTopLevelParent, terms, lfOrder, null);			
		}
...
//***********************QDSTerm collector*********************
	 ...
	 */		
	private void getFromChild(org.ifmc.mat.shared.model.Decision decisionPojo, Decision dbTopLevelParent, List<Object> terms, int orderNum) {
		if (decisionPojo==null) return;
...
//						getClauseDAO().save(clonedClause);
	...
	public ArrayList<String> getDependencyTree(org.ifmc.mat.shared.model.Decision decisionPojo){

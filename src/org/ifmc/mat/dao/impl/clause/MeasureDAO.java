...
public class MeasureDAO extends GenericDAO<Measure, String> implements org.ifmc.mat.dao.clause.MeasureDAO {
	...
	public MeasureShareDTO clone(ManageMeasureDetailModel currentDetails, String loggedinUserId, boolean creatingDraft,ApplicationContext context) {
		...
		org.ifmc.mat.dao.clause.MeasureDAO mDAO = null;
		org.ifmc.mat.dao.clause.ClauseDAO cDAO = null;
		UserDAO uDAO = null;
		org.ifmc.mat.dao.clause.MeasureSetDAO mSetDAO = null;
		...
		if (dAOService!=null) {
			...
			originalMeasure = ((org.ifmc.mat.dao.clause.MeasureDAO)context.getBean("measureDAO")).find(currentDetails.getId());
			mDAO = (org.ifmc.mat.dao.clause.MeasureDAO)context.getBean("measureDAO");
			qdsDAO = (QualityDataSetDAO)context.getBean("qualityDataSetDAO");
			cDAO = (org.ifmc.mat.dao.clause.ClauseDAO)context.getBean("clauseDAO");
			cm = new ClauseManagerDAO(context);
			uDAO = (UserDAO) context.getBean("userDAO");
			mSetDAO = (org.ifmc.mat.dao.clause.MeasureSetDAO) context.getBean("measureSetDAO");
...
//				m.setMeasure(cloned);
	...
	@Override
	public List<MeasureShareDTO> getMeasureShareInfoForUser(String searchText, org.ifmc.mat.dao.MetadataDAO metadataDAO,

...
import org.ifmc.mat.server.export.criteriontointerim.PropelDelegate;
import org.ifmc.mat.server.service.impl.CriterionToInterimUtility;
...
import org.ifmc.mat.shared.model.PrimitiveTerm;
...
import org.ifmc.mat.shared.model.StatementTerm.Operator;
import org.ifmc.mat.simplexml.model.And;
...
import org.ifmc.mat.simplexml.model.IPhrase;
import org.ifmc.mat.simplexml.model.Id;
...
import org.ifmc.mat.simplexml.model.To;
import org.ifmc.mat.simplexml.model.Value;
	...
	public LogicOp getInterim(Clause c) throws Exception {
		...
		if( c.getDecisions() != null && !c.getDecisions().isEmpty()) {
			 ...
			 if(!cl.getDecisions().isEmpty()) {
				 ...
				 return LogicOp.logicOpFactory(org.ifmc.mat.shared.model.Conditional.Operator.AND);
			 }
		 } 
		return null;
	}

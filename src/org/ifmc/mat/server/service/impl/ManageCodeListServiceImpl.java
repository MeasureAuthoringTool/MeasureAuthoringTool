...
import org.ifmc.mat.dao.AuthorDAO;
...
import org.ifmc.mat.dao.MeasureTypeDAO;
...
import org.ifmc.mat.shared.DateStringValidator;
...
public class ManageCodeListServiceImpl implements CodeListService {
	...
	@Autowired
	private org.ifmc.mat.dao.clause.MeasureDAO measureDAO;
	...
	public org.ifmc.mat.client.codelist.service.CodeListService.ListBoxData getListBoxData() {
		org.ifmc.mat.client.codelist.service.CodeListService.ListBoxData data = 
			new org.ifmc.mat.client.codelist.service.CodeListService.ListBoxData();
	...
	boolean isCodeListUnique(ManageCodeListDetailModel currentDetails) {
		boolean unique = true;
	...
	//US 413. Added Steward Other parameter
	boolean isGroupedCodeListUnique(ManageCodeListDetailModel currentDetails) {
		boolean unique = true;
...
//			if(!isCodeListLastModifiedDateUnique(currentDetails, ts)){
	...
	void filterCodeListsForCurrentCategory(ListObject listObject) {

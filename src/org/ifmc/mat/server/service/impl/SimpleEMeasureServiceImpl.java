...
import org.ifmc.mat.server.clause.ClauseBusinessService;
import org.ifmc.mat.server.export.AttachmentGenerator;
import org.ifmc.mat.server.export.AttachmentGenerator.PackageInfo;
import org.ifmc.mat.server.export.CriterionToInterim;
import org.ifmc.mat.server.export.ElementLookupGenerator;
import org.ifmc.mat.server.export.HeaderInfoGenerator;
import org.ifmc.mat.server.export.SimpleXMLWriter;
import org.ifmc.mat.server.export.SuppDataElementsGenerator;
import org.ifmc.mat.server.service.MeasurePackageService;
import org.ifmc.mat.server.service.SimpleEMeasureService;
...
import org.ifmc.mat.simplexml.model.CriterionWithAttachments;
...
import org.ifmc.mat.simplexml.model.SupplementalDataElements;
...
public class SimpleEMeasureServiceImpl implements SimpleEMeasureService{
	...
	private void doXSDValidation(String interimXML, String measureId) throws Exception{
		...
		org.ifmc.mat.model.clause.Measure measure = measureDAO.find(measureId);
	...
	private org.ifmc.mat.model.clause.Measure getMeasureName(String measureId) {
		MeasurePackageService measureService = (MeasurePackageService)context.getBean("measurePackageService");
		org.ifmc.mat.model.clause.Measure measure = measureService.getById(measureId);
		return measure;
	}

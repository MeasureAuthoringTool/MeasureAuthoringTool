...
public class MeasureLibraryServiceImplTest {
	...
	@Mock SessionImplementor mockSessionImplementor;
	@Mock SessionFactoryImplementor mockSessionFactoryImplementor;
	@Mock ServiceRegistryImplementor mockServiceRegistryImplementor;
	@Mock JdbcServices mockJdbcServices;
	@Mock LobCreator mockLobCreator;
	@Mock Blob mockBlob;
	...
	public void hibernateConfigTest() throws SerialException, SQLException {
		...
		Mockito.when(context.getBean("sessionFactory")).thenReturn(sessionFactory);
		Mockito.when(sessionFactory.openSession()).thenReturn(mockSession);
		Mockito.when(sessionFactory.getCurrentSession()).thenReturn(mockSessionImplementor);
